...
const LeavePolicies = () => {
		...
		const leavepolicies = async () => {
			...
			try {
				const response1 = await fetch(
					`${import.meta.env.VITE_API_URL}/leave-system-create`,
					{
						method: 'GET',
						headers: {
	...
	const yearTypeAddCalender = async (e) => {
		...
		try {
			setIsLoading1(true);
			const response = await fetch(
				`${import.meta.env.VITE_API_URL}/calender-type`,
				{
					method: 'POST',
					body: formData,
					headers: {
	...
	const ruleTypeOne = async (e) => {
		...
		try {
			setIsLoading3(true);
			const response = await fetch(
				`${import.meta.env.VITE_API_URL}/rule-type`,
				{
					method: 'POST',
					body: formData,
					headers: {
	...
	const ruleTypeIncrement = async (e) => {
		...
		try {
			...
			const response2 = await fetch(
				`${import.meta.env.VITE_API_URL}/increment-type`,
				{
					method: 'POST',
					body: formData,
					headers: {
	...
	const ruleTypeSandwitch = async (e) => {
		...
		try {
			setIsLoading5(true);
			const response = await fetch(
				`${import.meta.env.VITE_API_URL}/sandwich-update`,
				{
					method: 'POST',
					body: formData,
					headers: {
