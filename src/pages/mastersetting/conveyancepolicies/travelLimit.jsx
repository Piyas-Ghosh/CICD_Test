		...
		const travelLimit = async () => {
			try {
				...
				const response1 = await fetch(
					`${import.meta.env.VITE_API_URL}/convayence-mode-of-travel`,
					{
						method: 'GET',
						headers: {
				...
				const response2 = await fetch(
					`${import.meta.env.VITE_API_URL}/convayence-travel`,
					{
						method: 'GET',
						headers: {
							Authorization: `Bearer ${token}`,
				...
				const response3 = await fetch(
					`${import.meta.env.VITE_API_URL}/emp-grade`,
					{
						method: 'GET',
						headers: {
							Authorization: `Bearer ${token}`,
	...
	const travelLimitPost = async (e) => {
		...
		try {
			...
			const response = await fetch(
				`${import.meta.env.VITE_API_URL}/convayence-travel-post`,
				{
					method: 'POST',
					body: formData,
					headers: {
